  ...
  return (
    ...
    >
      ...
      <motion.div variants={variants}>
        I’m web developer located in Argentina. Mainly focused on the MERN
        stack.
        <br></br>
      ...
      <a href="../../Thomas Currículum.pdf" download>
        <Button variant="outline">View Resume</Button>
      </a>
        
      <HStack pt={8} justifyContent="center" alignItems="center">
        <Tooltip label="HTML">
          <Box p="1">
